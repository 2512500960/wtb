...
export const DEFAULT_PREFER_SCHEMES = ['tls', 'quic', 'wss', 'ws', 'tcp'] as const;

const schemeRank = (scheme: string | undefined, prefer: readonly string[]): number => {
...
export const loadBundledPublicPeers = (yggBaseDir: string): PublicPeerNode[] => {
...
export const pickRandomPublicPeerAddresses = (
	...
	for (const list of groups.values()) {
		list.sort((a, b) => {
			...
			return schemeRank(aScheme, preferSchemes) - schemeRank(bScheme, preferSchemes);
		});
